...
from data.simu4 import simu_data4
import argparse

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='generate simulate data')
    parser.add_argument('--save_dir', type=str, default='dataset/simu4', help='dir to save generated data')
    ...
    for delta in [0, 0.3, 0.5]:
        for _ in range(args.num_tune):
            ...
            train_matrix, t_grid = simu_data4(args.num_obs, delta) #500, 200
        ...
        for _ in range(args.num_eval):
            ...
            train_matrix, t_grid = simu_data4(args.num_obs, delta)
